// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 2018/1/22 13:24:27
...
// Referenced classes of package com.shove.security:
//            Ses, Des
...
public class Encrypt
{
    ...
    public static String encrypt3DES(String input, String key, Charset charset) throws Exception {
        return Byte.byte2hex(Des.encrypt(input.getBytes(charset.name()), key.getBytes()));
    }

    public static String decrypt3DES(String input, String key) throws Exception {
        return decrypt3DES(input, key, Charset.forName("GB2312"));
    }

    public static String decrypt3DES(String input, String key, Charset charset) throws Exception {
