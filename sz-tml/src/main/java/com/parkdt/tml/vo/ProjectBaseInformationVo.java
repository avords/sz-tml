...
public class ProjectBaseInformationVo implements Serializable {
    private Long id;
    ...
    private ProjectDeliveryVo projectDeliveryVo;
    ...
    public ProjectDeliveryVo getProjectDeliveryVo() {
        return projectDeliveryVo;
    }

    public void setProjectDeliveryVo(ProjectDeliveryVo projectDeliveryVo) {
        this.projectDeliveryVo = projectDeliveryVo;
    }
}