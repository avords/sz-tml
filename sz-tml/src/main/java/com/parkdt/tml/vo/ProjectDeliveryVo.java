...
public class ProjectDeliveryVo implements Serializable {
    ...
    private ProjectBaseInformationVo projectBaseInformationVo;
    ...
    public ProjectBaseInformationVo getProjectBaseInformationVo() {
        return projectBaseInformationVo;
    }

    public void setProjectBaseInformationVo(ProjectBaseInformationVo projectBaseInformationVo) {
        this.projectBaseInformationVo = projectBaseInformationVo;
    }
}